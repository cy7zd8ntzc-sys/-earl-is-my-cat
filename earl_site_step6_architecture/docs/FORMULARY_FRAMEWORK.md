...
- Acne, rosacea, pigment: usually 8-12 weeks unless safety or severity requires earlier review.
...
- `assets/js/formulary-data.js` - static preview loader for the JSON.
