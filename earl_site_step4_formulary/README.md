...
## Step 4: internal prescribing/formulary scaffold

This prototype includes a one-page provider dashboard (`provider.html`) with an internal formulary assistant powered by `assets/data/formulary.json`. This is decision support only; production use requires clinician review, legal/pharmacy review, backend PHI controls, audit logging, and secure pharmacy integration.
